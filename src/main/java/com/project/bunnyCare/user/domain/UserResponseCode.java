...
public enum UserResponseCode implements ResponseCode {
    ...
    EXPIRED_TOKEN(4001,"Unauthorized","만료된 토큰입니다"),
    MAL_FORMED_TOKEN(4002,"Unauthorized","잘못된 토큰 형식입니다"),
    INVALID_TOKEN(4003,"Unauthorized","유효하지 않은 토큰입니다"),
    UNSUPPORTED_TOKEN(4004,"Unauthorized","지원하지 않는 토큰입니다"),
    INVALID_REFRESH_TOKEN(4005,"Unauthorized","유효하지 않은 리프레시 토큰입니다"),
    IllegalArgumentException(4006,"Unauthorized","잘못된 인수입니다."),
