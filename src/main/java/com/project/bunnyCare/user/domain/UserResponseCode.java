...
public enum UserResponseCode implements ResponseCode {
    ...
    MAL_FORMED_TOKEN(401,"BAD REQUEST","잘못된 토큰 형식입니다"),
    EXPIRED_TOKEN(401,"BAD REQUEST","만료된 토큰입니다"),
    INVALID_TOKEN(401,"BAD REQUEST","유효하지 않은 토큰입니다"),
    UNSUPPORTED_TOKEN(401,"BAD REQUEST","지원하지 않는 토큰입니다"),
    INVALID_REFRESH_TOKEN(401,"BAD REQUEST","유효하지 않은 리프레시 토큰입니다"),
